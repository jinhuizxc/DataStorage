package com.example.jinhui.datastorage.sqlite;
 ...
 * 数据库的基本操作，日后有需要持续更新！
 */
public class SqLiteActivity extends AppCompatActivity implements AdapterView.OnItemLongClickListener, View.OnClickListener {
